...
class KGSearchService(BaseSearchService):
    ...
    def get_entity_relationships(self, entity_text: str, max_depth: int = 2) -> List[Dict[str, Any]]:
        ...
        sql_find = "SELECT EntityID FROM RAG.Entities WHERE LOWER(EntityText) = ?"
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        cursor.execute("SELECT EntityType, COUNT(*) as count FROM RAG.Entities GROUP BY EntityType")
